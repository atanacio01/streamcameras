    ...
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            try
            {
                ...
                AuxUser.getUser(model.Email);
                

                Subscriptions sus = new Subscriptions();
                sus.Id = Guid.NewGuid().ToString();
                sus.UserId = user.Id;
                sus.SubscriptionType = 2;
                sus.SubscriptionDate = DateTime.Now;
                sus.SubscriptionEndDate = DateTime.Now.AddDays(30);
                sus.IsActive = true;
                ...
                if (model.IsUser)
                {
                    ...
                    latincamEntities localContext = new latincamEntities();

                    localContext.Subscriptions.Add(sus);
